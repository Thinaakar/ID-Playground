...
contacting:'contacting server…',hintCors:'Staging MCP is unreachable. Start local ID-MCP (`npm run dev` in ../ID-MCP on :8787). Live Run on this site is proxied through /mcp.',
...
contacting:'menghubungi server…',hintCors:'MCP staging tidak terjangkau. Jalankan ID-MCP lokal (`npm run dev` di ../ID-MCP pada :8787). Run di situs ini diproksi lewat /mcp.',
